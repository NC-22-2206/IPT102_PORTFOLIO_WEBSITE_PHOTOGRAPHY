    ...
    <section class="gallery bg-dark" id="works">
        ...
        <div class="container">
            <ul class="filter-options">
                ...
                <li class="filter-btn" data-filter="landscapes">Landscapes</li>
                <li class="filter-btn" data-filter="portraits">Portraits</li>
                <li class="filter-btn" data-filter="travels">Travels</li>
                <li class="filter-btn" data-filter="products">Products</li>
            </ul>
        </div>
        <div class="container">
